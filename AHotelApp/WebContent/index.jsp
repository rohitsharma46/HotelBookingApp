...
<section class="view">
    ...
    <div class="row">
    	...
    	<button class=" mr-3" onclick="document.getElementById('id01').style.display='block'" style="width:auto;">Login</button>
         <button onclick="document.getElementById('id02').style.display='block'" style="width:auto;">Sign Up</button></div></div></div>
         
    <div id="id01" class="modal">
  
  <form class="modal-content animate" id="frm" action="Login" method="post">
...
<div id="id02" class="modal">
  ...
  <form class="modal-content animate" id="frm2" action="SignUp" method="post">
    <div class="imgcontainer">
    ...
    <label for="nUser" ><b>User Name</b></label>
    <input type="text" placeholder="Enter User Name" name="nUser" required>
    
    <label for="lUser" ><b>Last Name</b></label>
    <input type="text" placeholder="Enter Last Name" name="lUser" >
    
    <label for="age" ><b>Age</b></label> <label id="ageFactor"></label>
    <input type="text" id = "age" pattern="\d*" onkeyup="checkAge()" placeholder="Enter Your Age" name="age" required>

    <label for="nPwd" ><b>Password</b></label>
...
<div class="container">
  ...
  if (msg2 == null){
	  ...
	  out.println("Please try a Different User name ");
  }
